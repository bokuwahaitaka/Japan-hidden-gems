(() => {
  const translations = {
    ja: {
      ...
      ritual: "毎週月曜更新", mix: "Weekly Hidden Gems", share: "この選曲を共有", ranking: "ランキングを見る", refresh: "次回更新", vote: "推薦する", no: "推薦しない", rate: "聴いて評価", empty: "曲を読み込めませんでした。"
    },
    ...
    ko: { eyebrow:"이번 주 J-POP",title:"매주 새로운 명곡을 만나보세요.",copy:"매주 월요일 맞춤 선곡이 새로워집니다. 듣고, 평가하고, 저장하고, 발견을 공유하세요.",open:"이번 주 음악 열기",weekly:"주간 Hidden Gems",weeklyCopy:"매주 월요일 새로운 맞춤 선곡",replay:"나의 JHG Replay",replayCopy:"발견 기록을 공유 가능한 요약으로",blend:"JHG Blend",blendCopy:"취향을 비교하며 함께 발견",listen:"계속 듣기",listenCopy:"YouTube, Spotify, Apple Music에서 듣기",ritual:"매주 월요일 업데이트",mix:"Weekly Hidden Gems",share:"믹스 공유",ranking:"전체 랭킹",refresh:"다음 업데이트",vote:"추천",no:"추천 안 함",rate:"듣고 평가",empty:"아직 곡이 없습니다." },
    zh: { eyebrow:"本周 J-POP",title:"每周发现新的好歌。",copy:"每周一更新个性化歌单。试听、投票、收藏并分享你的发现。",open:"打开本周歌单",weekly:"每周 Hidden Gems",weeklyCopy:"每周一更新个性化选择",replay:"我的 JHG Replay",replayCopy:"把发现记录变成可分享总结",blend:"JHG Blend",blendCopy:"比较品味，一起发现",listen:"继续收听",listenCopy:"在 YouTube、Spotify 或 Apple Music 收听",ritual:"每周一更新",mix:"Weekly Hidden Gems",share:"分享歌单",ranking:"查看完整排行",refresh:"下次更新",vote:"推荐",no:"不推荐",rate:"试听并评分",empty:"暂无歌曲。" },
    ru: { eyebrow:"J-POP НА ЭТОЙ НЕДЕЛЕ",title:"Новая музыка каждую неделю.",copy:"Персональная подборка обновляется по понедельникам. Слушайте, голосуйте, сохраняйте и делитесь.",open:"Открыть подборку",weekly:"Weekly Hidden Gems",weeklyCopy:"Новая подборка каждый понедельник",replay:"Мой JHG Replay",replayCopy:"Поделитесь итогами своих открытий",blend:"JHG Blend",blendCopy:"Сравните вкусы и ищите вместе",listen:"Продолжить слушать",listenCopy:"Слушать в YouTube, Spotify или Apple Music",ritual:"ОБНОВЛЕНИЕ ПО ПОНЕДЕЛЬНИКАМ",mix:"Weekly Hidden Gems",share:"Поделиться",ranking:"Весь рейтинг",refresh:"Обновление",vote:"Рекомендовать",no:"Не моё",rate:"Слушать и оценить",empty:"Песен пока нет." },
    es: { eyebrow:"TU SEMANA EN J-POP",title:"Una nueva razón para volver.",copy:"Tu selección personal se renueva cada lunes. Escucha, vota, guarda y comparte.",open:"Abrir las joyas de esta semana",weekly:"Weekly Hidden Gems",weeklyCopy:"Una selección nueva cada lunes",replay:"Mi JHG Replay",replayCopy:"Convierte tus descubrimientos en un resumen",blend:"JHG Blend",blendCopy:"Compara gustos y descubre en compañía",listen:"Seguir escuchando",listenCopy:"Continúa en YouTube, Spotify o Apple Music",ritual:"RITUAL DE LOS LUNES",mix:"Weekly Hidden Gems",share:"Compartir selección",ranking:"Ver ranking",refresh:"Se renueva",vote:"Recomendar",no:"No es para mí",rate:"Escuchar y valorar",empty:"Aún no hay canciones." },
    fr: { eyebrow:"VOTRE SEMAINE J-POP",title:"Une nouvelle raison de revenir.",copy:"Une sélection personnelle arrive chaque lundi. Écoutez, votez, sauvegardez et partagez.",open:"Ouvrir les pépites de la semaine",weekly:"Weekly Hidden Gems",weeklyCopy:"Une nouvelle sélection chaque lundi",replay:"Mon JHG Replay",replayCopy:"Transformez vos découvertes en bilan partageable",blend:"JHG Blend",blendCopy:"Comparez vos goûts et découvrez ensemble",listen:"Continuer l'écoute",listenCopy:"Écouter sur YouTube, Spotify ou Apple Music",ritual:"RENDEZ-VOUS DU LUNDI",mix:"Weekly Hidden Gems",share:"Partager la sélection",ranking:"Voir le classement",refresh:"Actualisation",vote:"Recommander",no:"Pas pour moi",rate:"Écouter et noter",empty:"Aucun titre disponible." }
  };
